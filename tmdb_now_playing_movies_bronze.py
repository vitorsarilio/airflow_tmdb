...
def extract_tmdb_now_playing_movies(**context):
    ...
    try:
        ...
        daily_gcs_path = f"tmdb/bronze_local/now_playing_movies/now_playing_movies_{processing_date}.csv"
        ...
        # Arquivo diário de now_playing_movies
        ...
        # 6. Upload para o GCS
        try:
            # Upload do arquivo diário (now_playing_movies)
            gcs_hook.upload(
            ...
            try:
                ...
                df.to_csv(
                    f"{backup_dir}/now_playing_movies_{timestamp}.csv",
                    sep=';',
                    index=False,
                    encoding='utf-8-sig'
                )
